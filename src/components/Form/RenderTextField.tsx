...
const renderTextField: React.FC<FormControlPropsType> = React.memo (({label, input, meta: {touched, invalid, error}, ...custom}) => (
    <><TextField
        label={label}
        placeholder={label}
...
export const OrderForm = React.memo( function (props: PropsType) {
